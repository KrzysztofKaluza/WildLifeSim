...
void SimLogic::simulate()
{
	...
	while (duration < this->simulation_duration) {
		...
		//std::this_thread::sleep_for(sleep_time); // opóźnianie wykonywania pętli, by jedna tura zajmowała dokładnie sekundę, problem z obsługą przez MinGW gcc
...
{
	//zapisywaniie informacji do pliku
